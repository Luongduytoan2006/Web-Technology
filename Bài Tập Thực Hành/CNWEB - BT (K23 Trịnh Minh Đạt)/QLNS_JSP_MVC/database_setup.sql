-- ===================================================================
-- SCRIPT TẠO VÀ KHỞI TẠO DỮ LIỆU CHO DATABASE 'qlns_jsp_mvc_db'
-- Dành cho dự án Quản lý nhân sự bằng JSP/Servlet MVC
-- ===================================================================

-- Bước 1: Xóa database cũ nếu tồn tại và tạo database mới với hỗ trợ tiếng Việt
DROP DATABASE IF EXISTS `qlns_jsp_mvc_db`;
CREATE DATABASE `qlns_jsp_mvc_db` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `qlns_jsp_mvc_db`;

-- --------------------------------------------------------

-- Bước 2: Tạo cấu trúc cho bảng `admin`
-- Bảng này vẫn được giữ lại để tiện cho việc phát triển chức năng đăng nhập sau này
CREATE TABLE `admin` (
...
-- KẾT THÚC SCRIPT.
-- Bạn đã có thể bắt đầu làm việc với database 'qlns_jsp_mvc_db'.